...
OE_USER=$(whiptail --title "odoo install script" --inputbox "install username:" 50 10 root 3>&1 1>&2 2>&3)
OE_VERSION=$(whiptail --title "odoo install script" --inputbox "odoo version:" 50 10 root 3>&1 1>&2 2>&3)
OE_PORT=$(whiptail --title "odoo install script" --inputbox "odoo port:" 50 10 root 3>&1 1>&2 2>&3)
OE_PROJECT_NAME=$(whiptail --title "odoo install script" --inputbox "odoo project name:" 50 10 root 3>&1 1>&2 2>&3)
OE_ADDONS=$(whiptail --title "odoo install script" --inputbox "odoo addon path:" 50 10 root 3>&1 1>&2 2>&3)

# read -p "install username:" OE_USER
# read -p "odoo version: " OE_VERSION
# read -p "odoo port: " OE_PORT
# read -p "odoo project name: " OE_PROJECT_NAME
# read -p "odoo addon path: " OE_ADDONS
...
echo "home: " ${OE_HOME}
echo "odoo projct name: " ${OE_PROJECT_PATH}
echo "odoo config name: " ${OE_CONFIG}
echo "========================================="
if whiptail --yesno "Do you want to continue? \nodoo version: " 10 40 ;then
